...
describe('Create a Appointments with service', () => {
  ...
  const MockReturnFindAppointmentsBroken = {
    RepositoryStrategy: {
      findAppointments(data: any) {
        return false
      },
  ...
  it('should create a Appointments with service', async () => {
    ...
    const creatingAppointmentsAfter = await createAppointments.create.apply(MockReturnOk, [{
      id: '1233456789',
    ...
    const creatingAppointmentsBefore = await createAppointments.create.apply(MockReturnOk, [{
      id: '1233456789',
      idService: '1233456789',
      idClient: '1233456789',
      Day: 1,
  ...
  it('should not create a Appointments with service because Conflit of times', async () => {
    ...
    try {
      await createAppointments.create.apply(MockReturnOk, [{
        id: '1233456789',
        idService: '1233456789',
        idClient: '1233456789',
        Day: 1,
  ...
  it('should not create a Appointments with service because Service return false', async () => {


    try {
      await createAppointments.create.apply(mockThis, [{
        id: '1233456789',
        idService: '1233456789',
        idClient: '1233456789',
        Day: 1,
    ...
    try {
      await createAppointments.create.apply(MockReturnFindAppointmentsBroken, [{
        id: '1233456789',
        idService: '1233456789',
        idClient: '1233456789',
        Day: 1,
    ...
    try {
      await createAppointments.create.apply(MockCreateHasBroken, [{
        id: '1233456789',
        idService: '1233456789',
        idClient: '1233456789',
        Day: 1,
